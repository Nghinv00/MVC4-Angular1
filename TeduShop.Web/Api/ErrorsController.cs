...
namespace TeduShop.Web.API
{
    public class ErrorsController : ApiControllerBase
    {
        ...
        public HttpResponseMessage getById(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                var model = ErrorService.ReadID(id);
        ...
        [HttpPost]
        [AllowAnonymous]
        public HttpResponseMessage Create(HttpRequestMessage request, ErrorModel ErrorModel)
        {
            return CreateHttpResponse(request, () =>
            {
        ...
        [HttpPut]
        [AllowAnonymous]
        public HttpResponseMessage Update(HttpRequestMessage request, ErrorModel ErrorModel)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                {
                    var ErrorService = new ErrorService();
                    ErrorService.Update(ErrorModel);
                    response = request.CreateResponse(HttpStatusCode.OK);
                }
                return response;
            });
